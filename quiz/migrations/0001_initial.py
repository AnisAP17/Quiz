# Generated by Django 4.2.6 on 2023-11-29 11:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_answer', models.DateField(blank=True, null=True, verbose_name='ответ даты')),
                ('number_answer', models.FloatField(blank=True, null=True, verbose_name='числовой ответ')),
                ('range_start', models.FloatField(blank=True, null=True, verbose_name='начало диапазона')),
                ('range_end', models.FloatField(blank=True, null=True, verbose_name='конец диапазона')),
            ],
            options={
                'verbose_name': 'ответ',
